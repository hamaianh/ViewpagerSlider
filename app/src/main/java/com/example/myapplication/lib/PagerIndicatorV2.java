...
public class PagerIndicatorV2 extends LinearLayout implements ViewPagerExV2.OnPageChangeListener{

    private Context mContext;

    /**
     */
    private ViewPagerExV2 mPager;
    ...
    private PagerIndicatorV2.IndicatorVisibility mVisibility = PagerIndicatorV2.IndicatorVisibility.Visible;
    ...
    public PagerIndicatorV2(Context context) {
        this(context,null);
    }

    public PagerIndicatorV2(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        int visibility = attributes.getInt(R.styleable.PagerIndicator_visibility, PagerIndicatorV2.IndicatorVisibility.Visible.ordinal());
        ...
        //setDefaultSelectedIndicatorSize(mDefaultSelectedWidth,mDefaultSelectedHeight, PagerIndicatorV2.Unit.Px);
        //setDefaultUnselectedIndicatorSize(mDefaultUnSelectedWidth,mDefaultUnSelectedHeight, PagerIndicatorV2.Unit.Px);
    ...
    public void setDefaultSelectedIndicatorSize(float width, float height, PagerIndicatorV2.Unit unit){
        if(mUserSetSelectedIndicatorResId == 0){
            float w = width;
            float h = height;
            if(unit == PagerIndicatorV2.Unit.DP){
                w = pxFromDp(width);
                h = pxFromDp(height);
            }
    ...
    public void setDefaultUnselectedIndicatorSize(float width, float height, PagerIndicatorV2.Unit unit){
        if(mUserSetUnSelectedIndicatorResId == 0){
            float w = width;
            float h = height;
            if(unit == PagerIndicatorV2.Unit.DP){
    ...
    public void setDefaultIndicatorSize(float width, float height, PagerIndicatorV2.Unit unit){
    ...
    public void setIndicatorVisibility(PagerIndicatorV2.IndicatorVisibility visibility){
        if(visibility == PagerIndicatorV2.IndicatorVisibility.Visible){
    ...
    public void destroySelf(){
        ...
        InfinitePagerAdapterV2 wrapper = (InfinitePagerAdapterV2)mPager.getAdapter();
    ...
    /**
     * bind indicator with ViewPagerExV2.
     * @param pager
     */
    public void setViewPager(ViewPagerExV2 pager){
        if(pager.getAdapter() == null){
            throw new IllegalStateException("Viewpager does not have adapter instance");
        }
        mPager = pager;
        mPager.addOnPageChangeListener(this);
        ((InfinitePagerAdapterV2)mPager.getAdapter()).getRealAdapter().registerDataSetObserver(dataChangeObserver);
    }
    ...
    private int getShouldDrawCount(){
        if(mPager.getAdapter() instanceof InfinitePagerAdapterV2){
            return ((InfinitePagerAdapterV2)mPager.getAdapter()).getRealCount();
        }else{
    ...
    private DataSetObserver dataChangeObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            int count = 0;
            if(adapter instanceof InfinitePagerAdapterV2){
                count = ((InfinitePagerAdapterV2)adapter).getRealCount();
            }else{
